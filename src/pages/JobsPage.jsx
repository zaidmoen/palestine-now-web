...
import { jobItems, jobCategories, cities, jobTypes } from '../data/jobs';
    ...
    <div className="relative min-h-screen overflow-hidden pt-[88px] font-cairo" dir="rtl" style={{ background: 'var(--bg)' }}>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-base lg:text-lg leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                نموذج متكامل للبحث والفرز ومقارنة الفرص. الوظائف الحالية بيانات تجريبية ولا تستقبل طلبات توظيف حقيقية.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <div className="rounded-2xl border border-amber-400/15 bg-amber-400/[0.06] px-5 py-4 text-sm font-bold leading-7 text-text-secondary">
                بيانات نموذجية · تحقق من الشركة والموعد قبل مشاركة أي مستند
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mb-5">
          <p className="text-sm font-bold" style={{ color: 'var(--text-muted)' }}>{filtered.length} فرصة نموذجية</p>
        </div>
            ...
            <>
              ...
              >
                ...
                <div className="p-6 space-y-6">
                  ...
                  <button type="button" disabled className="btn-primary w-full justify-center text-base opacity-60 cursor-not-allowed">
                    التقديم غير مفعّل في نسخة العرض
                  </button>
                </div>
              </motion.div>
            </>
