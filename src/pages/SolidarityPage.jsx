      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg lg:text-xl leading-relaxed max-w-3xl mx-auto mb-10" style={{ color: 'var(--text-secondary)' }}>
            تصور لواجهة توثّق المبادرات الإنسانية وأهدافها وأثرها. التبرع غير مفعّل حتى إضافة تحقق قانوني وبوابة دفع مرخّصة.
          </p>
            ...
            {filteredCampaigns.map((campaign, idx) => (
              ...
              >
                ...
                <button
                  type="button"
                  disabled
                  className="w-full h-12 rounded-2xl flex items-center justify-center gap-2 text-sm font-black text-white opacity-75 cursor-not-allowed"
                  style={{ background: campaign.color, boxShadow: `0 8px 20px -6px ${campaign.color}66` }}
                >
                  {campaign.completed ? 'حملة نموذجية مكتملة' : 'التبرع غير مفعّل في نسخة العرض'}
                </button>
              </motion.div>
            ))}
          </AnimatePresence>
        ...
        <section className="mt-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black mb-4" style={{ color: 'var(--text-primary)' }}>نماذج لقصص الأثر</h2>
            <p className="text-base opacity-60 max-w-xl mx-auto" style={{ color: 'var(--text-muted)' }}>
              أمثلة تحريرية توضّح كيف يمكن توثيق أثر الحملات بعد اعتماد قصص حقيقية وموافقات واضحة.
            </p>
          </div>
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <p className="text-lg opacity-80 mb-10 leading-relaxed">
              يمكن للنسخة الإنتاجية استقبال المبادرات بعد إضافة التحقق من الهوية والجهة المستفيدة وبوابة دفع مرخّصة.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link to="/search?q=حملة" className="h-14 px-8 rounded-2xl bg-white text-primary font-black flex items-center gap-2 hover:bg-opacity-90 transition-all">
                ابحث في الحملات <ArrowLeft size={20} />
              </Link>
            </div>
          </div>
        </motion.section>
