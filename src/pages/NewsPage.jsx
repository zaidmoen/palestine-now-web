      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 pb-20 sm:px-6 lg:px-8">
        <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-bold text-primary-light">سجل نموذجي</p>
                <h2 className="mt-2 text-3xl font-extrabold text-t1">كيف تظهر التحديثات</h2>
              </div>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="text-sm font-bold text-primary-light">معيار التحرير</p>
              <h2 className="mt-2 text-3xl font-extrabold text-t1">
                الخبر المفيد يوضح المصدر والوقت وما الذي تغيّر
              </h2>
              <p className="mt-4 max-w-3xl text-sm leading-8 text-t2 sm:text-base">
                صُممت الواجهة لتدعم خبرًا رئيسيًا وبطاقات قابلة للتصفية والبحث. قبل الإطلاق العام يجب ربطها
                بنظام تحرير يفرض المصدر، تاريخ النشر، سجل التحديث، وتصحيح الأخطاء بوضوح.
              </p>
            </div>
