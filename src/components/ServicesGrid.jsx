...
const services = [
  {
    id: 'search',
    icon: Search,
    title: 'بحث فلسطيني موحّد',
    description: 'ابحث داخل محتوى المنصة كاملًا من مكان واحد، مع تصنيف النتائج والوصول المباشر إلى القسم المناسب.',
    to: '/search',
    color: '#00E676',
  ...
  },
  {
    ...
    icon: Newspaper,
    title: 'الأخبار',
    description: 'واجهة واضحة لعرض الأخبار والتحديثات عند ربط مصدر تحريري موثوق.',
    to: '/news',
    color: '#A855F7',
  ...
  },
  {
    ...
    icon: Briefcase,
    title: 'فرص العمل',
    description: 'تصفّح فرصًا نموذجية مع فرز حسب المدينة والتخصص ونوع الدوام.',
    to: '/jobs',
    color: '#FFD700',
  ...
  },
  {
    ...
    icon: MapPin,
    title: 'حالة الطرق',
    description: 'نموذج منظم لحالة الحواجز والمعابر والمسارات البديلة.',
    to: '/roads',
    color: '#00B4D8',
  ...
  },
  {
    ...
    description: 'واجهة لمقارنة أسعار العملات والذهب والوقود عند ربط مصدر حي.',
    to: '/economy',
    color: '#4ADE80',
